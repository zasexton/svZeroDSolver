...
void ClosedLoopRCRBC::update_constant(SparseSystem& system,
  ...
  system.add_F(global_eqn_ids[0], global_var_ids[3], 1.0);
  system.add_F(global_eqn_ids[1], global_var_ids[0], 1.0);
  system.add_F(global_eqn_ids[1], global_var_ids[4], -1.0);
  system.add_F(global_eqn_ids[2], global_var_ids[2], -1.0);
  system.add_F(global_eqn_ids[2], global_var_ids[4], 1.0);

  // Below values can be unsteady if needed (not currently implemented)
  system.add_E(global_eqn_ids[0], global_var_ids[4],
               parameters[global_param_ids[ParamId::C]]);
  system.add_F(global_eqn_ids[1], global_var_ids[1],
               -parameters[global_param_ids[ParamId::RP]]);
  system.add_F(global_eqn_ids[2], global_var_ids[3],
