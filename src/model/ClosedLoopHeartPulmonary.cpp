...
void ClosedLoopHeartPulmonary::update_constant(
  ...
  system.add_E(global_eqn_ids[1], global_var_ids[2],
  ...
  system.add_E(global_eqn_ids[3], global_var_ids[5],
               parameters[global_param_ids[ParamId::LRA_V]]);
  system.add_F(global_eqn_ids[3], global_var_ids[0], -1.0);
  system.add_F(global_eqn_ids[3], global_var_ids[6], 1.0);

  // DOF 6, Eq 4: Right ventricle pressure
  system.add_F(global_eqn_ids[4], global_var_ids[6], 1.0);

  // DOF 7, Eq 5: Right ventricle volume
  system.add_E(global_eqn_ids[5], global_var_ids[7], 1.0);

  // DOF 8, Eq 6: Right ventricle outflow
  system.add_E(global_eqn_ids[6], global_var_ids[8],
               parameters[global_param_ids[ParamId::LRV_A]]);
  system.add_F(global_eqn_ids[6], global_var_ids[6], -1.0);
  system.add_F(global_eqn_ids[6], global_var_ids[9], 1.0);
  ...
  system.add_E(global_eqn_ids[9], global_var_ids[11], 1.0);

  // DOF 12, Eq 10: Left atrium outflow
  system.add_E(global_eqn_ids[10], global_var_ids[12],
               parameters[global_param_ids[ParamId::LLA_V]]);
  system.add_F(global_eqn_ids[10], global_var_ids[10], -1.0);
  system.add_F(global_eqn_ids[10], global_var_ids[13], 1.0);

  // DOF 13, Eq 11: Left ventricle pressure
  system.add_F(global_eqn_ids[11], global_var_ids[13], 1.0);

  // DOF 14, Eq 12: Left ventricle volume
  system.add_E(global_eqn_ids[12], global_var_ids[14], 1.0);

  // DOF 15, Eq 13: Left ventricle outflow
  system.add_F(global_eqn_ids[13], global_var_ids[2], 1.0);
  system.add_F(global_eqn_ids[13], global_var_ids[13], -1.0);
  system.add_E(global_eqn_ids[13], global_var_ids[15],
...
void ClosedLoopHeartPulmonary::update_time(SparseSystem& system,
  ...
  // DOF 0, Eq 0: Right atrium pressure
  system.add_F(global_eqn_ids[0], global_var_ids[4],
               -AA * parameters[global_param_ids[ParamId::EMAX_RA]]);

  // DOF 6, Eq 4: Right ventricle pressure
  system.add_F(global_eqn_ids[4], global_var_ids[7], -Erv);
  system.C(global_eqn_ids[4]) =
      Erv * parameters[global_param_ids[ParamId::VRV_U]];

  // DOF 10, Eq 8: Left atrium pressure
  system.add_F(global_eqn_ids[8], global_var_ids[11],
               -AA * parameters[global_param_ids[ParamId::EMAX_LA]]);

  // DOF 13, Eq 11: Left ventricle pressure
  system.add_F(global_eqn_ids[11], global_var_ids[14], -Elv);
...
void ClosedLoopHeartPulmonary::update_solution(
  ...
  system.C(global_eqn_ids[8]) =
      ...
      psi_la * (AA - 1.0);
  system.add_dC_dy(global_eqn_ids[8], global_var_ids[11],
                   psi_la_derivative * (AA - 1.0));

  // DOF 2, Eq 1: Aortic pressure
  system.add_F(global_eqn_ids[1], global_var_ids[15], -valves[15]);

  // DOF 9, Eq 7: Pulmonary pressure
  system.add_F(global_eqn_ids[7], global_var_ids[8], -valves[8]);

  // DOF 4, Eq 2: Right atrium volume
  system.add_F(global_eqn_ids[2], global_var_ids[5], valves[5]);

  // DOF 7, Eq 5: Right ventricle volume
  system.add_F(global_eqn_ids[5], global_var_ids[5], -valves[5]);
  system.add_F(global_eqn_ids[5], global_var_ids[8], valves[8]);

  // DOF 11, Eq 9: Left atrium volume
  system.add_F(global_eqn_ids[9], global_var_ids[8], -valves[8]);
  system.add_F(global_eqn_ids[9], global_var_ids[12], valves[12]);

  // DOF 14, Eq 12: Left ventricle volume
  system.add_F(global_eqn_ids[12], global_var_ids[12], -valves[12]);
  system.add_F(global_eqn_ids[12], global_var_ids[15], valves[15]);

  // DOF 5, Eq 3: Right atrium outflow
  system.add_F(global_eqn_ids[3], global_var_ids[5],
               parameters[global_param_ids[ParamId::RRA_V]] * valves[5]);

  // DOF 8, Eq 6: Right ventricle outflow
  system.add_F(global_eqn_ids[6], global_var_ids[8],
               parameters[global_param_ids[ParamId::RRV_A]] * valves[8]);

  // DOF 12, Eq 10: Left atrium outflow
  system.add_F(global_eqn_ids[10], global_var_ids[12],
               parameters[global_param_ids[ParamId::RLA_V]] * valves[12]);

  // DOF 15, Eq 13: Left ventricle outflow
  system.add_F(global_eqn_ids[13], global_var_ids[15],
